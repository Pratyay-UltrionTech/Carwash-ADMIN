                    ...
                    >
                      ...
                      <TableCell className="px-1 py-2 text-right">
                        {(() => {
                          ...
                          const waDigits = (j.phone || '').replace(/\D/g, '');
                          return (
                            <div className="inline-flex items-center justify-end gap-1.5">
                              ...
                              <Button
                                ...
                                disabled={!waDigits}
                                aria-label={waDigits ? `Open WhatsApp chat with ${j.customerName}` : 'WhatsApp unavailable: no phone number'}
                                title={waDigits ? 'Open WhatsApp chat' : 'No phone number'}
                                onClick={() => {
                                  if (!waDigits) return;
